...
struct PrizmWidget : ModuleWidget
{
	PrizmWidget(Prizm* module)
    {
        ...
        addParam(createParam<RoundSmallBlackKnob>(Vec(scale_x * 88.6f, scale_y * 41.7f), module, Prizm::C_WAVE_SHAPE));
        addParam(createParam<RoundSmallBlackKnob>(Vec(scale_x * 88.6f, scale_y * 99.0f), module, Prizm::D_WAVE_SHAPE));
        ...
        addParam(createParam<RoundSmallBlackKnob>(Vec(scale_x * 108.6f, scale_y * 58.0f), module, Prizm::C_INTENSITY));
        addParam(createParam<RoundSmallBlackKnob>(Vec(scale_x * 108.6f, scale_y * 116.1f), module, Prizm::D_INTENSITY));
